...
export async function GET() {
  ...
  const [schoolsRes, costRes, visaRes, safetyRes, climateRes, jobsRes] = await Promise.all([
    ...
    supabase.from("city_jobs").select("city_id, city, indeed_casual_count, score_jobs, score_japanese_jobs, farm_nearby, fetched_at"),
  ]);
