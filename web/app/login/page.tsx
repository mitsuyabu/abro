      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-border p-8 flex flex-col gap-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white border border-border hover:border-primary/30 hover:shadow-sm text-primary font-medium py-3 px-4 rounded-2xl transition-all"
          >
            {/* Google icon */}
